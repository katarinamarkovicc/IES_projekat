...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			typeIdsInInsertOrder.Add(ModelCode.SWITCH); //proveriti redosled !!! 
			...
			typeIdsInInsertOrder.Add(ModelCode.TAPSCHEDULE);			//ovde mora regcontrol pre regschedule jer ga ovaj posle referencira
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROLE_REGULATIONSCHEDULE);	
		}
